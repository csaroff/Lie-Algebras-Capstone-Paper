...
In this project, I examine what Lie Algebras are, what operators are defined
on them and how to represent those operators as matrices.  I also examine how
to use linear algebra to apply these operators to vectors.  Examples of these
operators are described in algebraic form, and an algorithm is given for
